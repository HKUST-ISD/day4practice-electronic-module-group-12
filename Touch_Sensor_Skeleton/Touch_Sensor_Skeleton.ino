...
#define TOUCHPIN 1                    // ***Replace the ? with the GPIO pin you selected as touch pin
#define LED 2                       // ***Replace the ? with the GPIO pin you selected to control LED
#define THRESHOLD 30000               // ***Observe the reading when the pin is touched. Then modify this threshold.***
